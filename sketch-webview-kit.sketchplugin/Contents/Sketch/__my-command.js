...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  win.loadURL(__webpack_require__(/*! ../web/plugin/dist/index.html */ "./web/plugin/dist/index.html")); // win.webContents
  ...
  win.webContents.on('readDoc', function (s) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("\u83B7\u53D6\u9009\u4E2D\u6587\u6863\uFF0C\u53C2\u6570\uFF1A".concat(s));
  ...
  win.webContents.on('writeDoc', function (s) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("\u5199\u5165\u9009\u4E2D\u6587\u6863\uFF0C\u53C2\u6570\uFF1A".concat(s));
    var document = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument(); // Next we want to extract the selected page of the document
    ...
    layer.adjustToFit(); // Finally, lets center the view on our new layer
...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/dd5895622a2a7738689bd82b53131984.html";
